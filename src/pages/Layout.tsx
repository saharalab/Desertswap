  ...
  return (
    <Web3ConnectorConfig>
      <main className=" h-full flex flex-col items-center w-full">
        ...
        <div className="bg-supernova 2xl:border border-black shadow-2xl shadow-black flex justify-center lg:pb-14 sm:!pb-0 !z-0 2xl:container w-full xl:h-auto h-max flex-grow ">
          {children}
        </div>
