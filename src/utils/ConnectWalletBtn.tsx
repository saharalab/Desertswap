  ...
  return (
    <ConnectButton.Custom>
      {({
        ...
        return (
          <div
            className="mr-1 sm:mr-3 text-secondary-alfa"
            {...(!mounted && {
              "aria-hidden": true,
              style: {
                opacity: 0,
              ...
              if (!mounted || !account || !chain) {
                return (
                  <button
                    ...
                    type="button"
                    className="group translate-y-[2px] px-5 pb-2 pt-2 rounded-lg border-solid border-[1px] border-paleGrey bg-gray-900"
                  >
